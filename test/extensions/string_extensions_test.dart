...
void main() {
  group('String extensions', () {
    ...
    void validateLines(final List<String> actualLines,
        final List<String> expectedLines, final int length) {
    ...
    group('wrap text', () {
      test('wrap', () {
        validateLines(
            'this is a demo text with rounded borders'
                .splitEvery(20, splitWords: false, lineBreak: false),
            <String>['this is a demo text ', 'with rounded borders'],
            20);
      });
      ...
      test('split words', () {
        validateLines(
            'this is a demo text with rounded borders'
                .splitEvery(5, splitWords: true, lineBreak: false),
            <String>[
              'this ',
              'is a ',
              'demo ',
      ...
      test('line break', () {
        validateLines(
            'this is a demo text with rounded borders'
                .splitEvery(10, splitWords: true, lineBreak: true),
            <String>[
              'this is a ',
              'demo text ',
              'with roun-',
