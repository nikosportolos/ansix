  ...
  group('AnsiTable.fromMap', () {
    ...
    group('with styles', () {
      test('all styles', () {
        ...
        expect(table.formattedText, tableWithAllStylesMock);
      });
      ...
      test('only cell style', () {
        ...
        expect(table.formattedText, tableWithCellStyleMock);
      });
    });
  });
}
...
const String tableWithAllStylesMock = '''
┌───────────────────┬───────────────────┬───────────────────┐
...
const String tableWithCellStyleMock = '''
┌───────────────────┬───────────────────┬───────────────────┐
│[38;5;72m[38;5;72mColumn 1[0m[0m           │[38;5;72m[38;5;72m[1mColumn 2[22m[0m[0m           │[38;5;72m[38;5;72mColumn 3[0m[0m           │
├───────────────────┼───────────────────┼───────────────────┤
│[38;5;72m[38;5;72m1[0m[0m                  │[38;5;72m[38;5;72m1[0m[0m                  │[38;5;72m[38;5;72mrow 1[0m[0m              │
├───────────────────┼───────────────────┼───────────────────┤
│[38;5;72m[38;5;72m2[0m[0m                  │[38;5;72m[38;5;72m2[0m[0m                  │[38;5;72m[38;5;72mrow 2[0m[0m              │
...
│[38;5;72m[38;5;72m6[0m[0m                  │                   │                   │
├───────────────────┼───────────────────┼───────────────────┤
│[38;5;72m[38;5;72m7[0m[0m                  │[38;5;72m[38;5;72m7[0m[0m                  │[38;5;72m[38;5;72mrow 7[0m[0m              │
└───────────────────┴───────────────────┴───────────────────┘''';
